export interface QuizItem {
  ...
  export const questions: QuizItem[] = [
    ...
    { id: '5', question: 'What stablecoin is native to the Mantle platform?', options: ['USDT', 'USDC', 'cUSD', 'DAI'], correctAnswer: 2 },
    ...
    { id: '19', question: 'How can you pay for gas on Mantle?', options: ['Only Mantle', 'Mantle or cUSD', 'Bitcoin', 'Fiat cash'], correctAnswer: 1 },
  ...
  { id: '40', question: 'What is the gas token on Mantle?', options: ['Fiat currency', 'Bitcoin', 'Only ETH', 'Mantle or stable tokens like cUSD'], correctAnswer: 3 },
