...
export function getContractAddresses(chainId?: number) {
  ...
  const isSepoliaTestnet = chainId === undefined || chainId === 5003;
  return isSepoliaTestnet ? CONTRACTS_BY_NETWORK.SepoliaTestnet : CONTRACTS_BY_NETWORK.TESTNET;
}
...
export const CONTRACTS = CONTRACTS_BY_NETWORK.SepoliaTestnet;
